...
public class StarshipsRawResultDeserializer extends StdDeserializer<List<StarshipsRawResult>> {

    public StarshipsRawResultDeserializer() {
        this(null);
    }
    public StarshipsRawResultDeserializer(Class<?> vc) {
        super(vc);
    }
